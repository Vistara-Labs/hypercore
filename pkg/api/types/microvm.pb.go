...
type MicroVMRuntimeData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The TAP device linked to the VM
	NetworkInterface string `protobuf:"bytes,1,opt,name=network_interface,json=networkInterface,proto3" json:"network_interface,omitempty"`
}

func (x *MicroVMRuntimeData) Reset() {
	*x = MicroVMRuntimeData{}
	if protoimpl.UnsafeEnabled {
...
func (x *MicroVMRuntimeData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MicroVMRuntimeData) ProtoMessage() {}

func (x *MicroVMRuntimeData) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_api_types_microvm_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MicroVMRuntimeData.ProtoReflect.Descriptor instead.
func (*MicroVMRuntimeData) Descriptor() ([]byte, []int) {
	return file_pkg_api_types_microvm_proto_rawDescGZIP(), []int{1}
}

func (x *MicroVMRuntimeData) GetNetworkInterface() string {
	if x != nil {
...
type MicroVMSpec struct {
	...
	KernelPath *string `protobuf:"bytes,4,opt,name=kernel_path,json=kernelPath,proto3,oneof" json:"kernel_path,omitempty"`
	// RootVolume specifies the root volume mount for the MicroVM.
	RootfsPath *string `protobuf:"bytes,5,opt,name=rootfs_path,json=rootfsPath,proto3,oneof" json:"rootfs_path,omitempty"`
	// HostNetDev is the device to use for passing traffic through the TAP device
	HostNetDev *string `protobuf:"bytes,6,opt,name=HostNetDev,proto3,oneof" json:"HostNetDev,omitempty"`
	// MAC address of the guest interface
	GuestMac *string `protobuf:"bytes,7,opt,name=GuestMac,proto3,oneof" json:"GuestMac,omitempty"`
	// Reference of the container to spawn
	ImageRef *string `protobuf:"bytes,8,opt,name=ImageRef,proto3,oneof" json:"ImageRef,omitempty"`
...
func (x *MicroVMSpec) GetImageRef() string {
...
var file_pkg_api_types_microvm_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x6d, 0x70, 0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x0e,
	0x0a, 0x0c, 0x5f, 0x6b, 0x65, 0x72, 0x6e, 0x65, 0x6c, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x42, 0x0e,
	0x0a, 0x0c, 0x5f, 0x72, 0x6f, 0x6f, 0x74, 0x66, 0x73, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x42, 0x0d,
	0x0a, 0x0b, 0x5f, 0x48, 0x6f, 0x73, 0x74, 0x4e, 0x65, 0x74, 0x44, 0x65, 0x76, 0x42, 0x0b, 0x0a,
	0x09, 0x5f, 0x47, 0x75, 0x65, 0x73, 0x74, 0x4d, 0x61, 0x63, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x49,
	0x6d, 0x61, 0x67, 0x65, 0x52, 0x65, 0x66, 0x42, 0x15, 0x5a, 0x13, 0x70, 0x6b, 0x67, 0x2f, 0x61,
...
var file_pkg_api_types_microvm_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_api_types_microvm_proto_goTypes = []interface{}{
	(*MicroVM)(nil),               // 0: MicroVM
	(*MicroVMRuntimeData)(nil),    // 1: MicroVMRuntimeData
	(*MicroVMSpec)(nil),           // 2: MicroVMSpec
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_pkg_api_types_microvm_proto_depIdxs = []int32{
	2, // 0: MicroVM.spec:type_name -> MicroVMSpec
	3, // 1: MicroVMSpec.created_at:type_name -> google.protobuf.Timestamp
	3, // 2: MicroVMSpec.updated_at:type_name -> google.protobuf.Timestamp
	3, // 3: MicroVMSpec.deleted_at:type_name -> google.protobuf.Timestamp
...
func file_pkg_api_types_microvm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_api_types_microvm_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MicroVMRuntimeData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
